...
<html lang="en">
<head>
    <title>Code coverage report for src/service/ngJwtAuthService.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/service/</a> ngJwtAuthService.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">99.57% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>229/230</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>228/229</span>
      </div>
    </div>
  </div>
...
554
555
556</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
var NgJwtAuthService = (function () {
    ...
    NgJwtAuthService.prototype.retrieveAndProcessToken = function (endpoint, authHeader) {
        ...
        return this.$http(requestConfig).then(function (result) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (result &amp;&amp; result.data) {
    ...
    NgJwtAuthService.prototype.requireCredentialsAndAuthenticate = function () {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.userLoggedInPromise) {
    ...
    NgJwtAuthService.prototype.logout = function () {
        ...
        this.user = null;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!!this.userLoggedInPromise) {
<span class="cstat-no" title="statement not covered" >            this.userLoggedInPromise = null;</span>
        }
    };
    /**
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Tue Jun 07 2016 08:49:31 GMT+0000 (UTC)
</div>
</div>
